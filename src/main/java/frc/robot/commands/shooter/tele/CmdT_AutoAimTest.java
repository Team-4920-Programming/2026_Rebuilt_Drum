...
public class CmdT_AutoAimTest extends Command {
  ShooterSubsystem m_shooter;
  SwerveSubsystem m_swerve;
  IntakeSubsystem m_intake;
  /** Creates a new CmdT_ShootTillEmpty. */
  public CmdT_AutoAimTest(ShooterSubsystem m_ShooterSubsystem, SwerveSubsystem m_SwerveSubsystem, IntakeSubsystem m_IntakeSubsystem) {
