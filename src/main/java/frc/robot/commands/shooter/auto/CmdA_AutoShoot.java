...
public class CmdA_AutoShoot extends Command {
  ...
  public CmdA_AutoShoot(ShooterSubsystem m_ShooterSubsystem, SwerveSubsystem m_SwerveSubsystem, IntakeSubsystem m_IntakeSubsystem) {
